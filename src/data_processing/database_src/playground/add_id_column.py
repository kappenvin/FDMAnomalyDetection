...
parts_name_dict = {name: i + 1 for i, name in enumerate(parts_name)}


print(parts_name_dict)
print(slicer_settings_dict)

images["parts_id"] = images["PartName"].map(parts_name_dict)
"""
...
new_images_csv = r"C:\Anomaly_detection_3D_printing\data\csv_files\final_data_with_slicer_settings_parts_id.csv"
